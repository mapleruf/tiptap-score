...
__export(index_exports, {
  ScoreBubbleMenu: () => ScoreBubbleMenu_default,
  ScoreExtension: () => ScoreExtension_default,
  defaultScoreAttrs: () => defaultScoreAttrs,
...
// src/scoreUtils.ts
var import_vexflow = require("vexflow");
...
var attachDots = (note, count) => {
  ...
  for (let i = 0; i < dotCount; i += 1) {
    import_vexflow.Dot.buildAndAttach([note], { all: true });
  }
};
var parseNoteToken = (token, beatValue, clef) => {
  ...
  if (pitch === "r") {
    ...
    const note2 = new import_vexflow.StaveNote({ keys: [restKeyByClef(clef)], duration: restDuration, clef });
  ...
  const note = new import_vexflow.StaveNote({ keys: [key], duration, clef });
  attachDots(note, dotCount);
  if (accidental) {
    note.addAccidental(0, new import_vexflow.Accidental(accidental));
  }
  return {
    note,
    beats,
...
var buildVoice = (notes, numBeats, beatValue) => {
  const voice = new import_vexflow.Voice({ num_beats: numBeats, beat_value: beatValue });
...
var getRequiredMeasureWidth = (groupedNotes, groupedBeats, beatsPerMeasure, beatValue, clef) => {
  ...
  groupedNotes.forEach((measureNotes, idx) => {
    ...
    while (remainingBeats > 1e-4) {
      ...
      if (!picked) break;
      const rest = new import_vexflow.StaveNote({ keys: [restKeyByClef(clef)], duration: `${picked}r`, clef });
      tickables.push(rest);
    ...
    const formatter = new import_vexflow.Formatter();
...
var drawMeasureVoices = (context, stave, groupedNotes, groupedBeats, groupedSourceTokenIndices, groupedTuplets, measureBoundaries, beatsPerMeasure, beatValue, clef, selectedTokenIndices = []) => {
  ...
  const buildBeams = (notes, forceSingle = false) => {
    ...
    if (forceSingle) return [new import_vexflow.Beam(notes)];
    return import_vexflow.Beam.generateBeams(notes, {
  ...
  groupedNotes.forEach((measureNotes, idx) => {
    ...
    const measureStave = new import_vexflow.Stave(startX, stave.getY(), endX - startX);
    ...
    while (tupletStart < measureNotes.length) {
      ...
      for (let i = 0; i + 2 < run.length; i += 3) {
        ...
        const tuplet = new import_vexflow.Tuplet(group, {
          num_notes: 3,
          notes_occupied: 2,
          bracketed,
          ratioed: false
...
var drawTies = (context, notes, tiesNext, pitchKeys) => {
  for (let i = 0; i < notes.length - 1; i += 1) {
    ...
    if (pitchKeys[i] !== pitchKeys[i + 1]) continue;
    const tie = new import_vexflow.StaveTie({
      firstNote: notes[i],
      lastNote: notes[i + 1],
      firstIndexes: [0],
      lastIndexes: [0]
...
var renderScoreSvg = (container, attrs, selectedNotes = null) => {
  ...
  if (attrs.staff === "grand") {
    ...
    const connector = new import_vexflow.StaveConnector(stave, lowerStave);
    connector.setType(import_vexflow.StaveConnector.type.BRACE);
    connector.setContext(context).draw();
    const line = new import_vexflow.StaveConnector(stave, lowerStave);
    line.setType(import_vexflow.StaveConnector.type.SINGLE);
...
var ScoreNodeView = ({ node, editor, getPos, extension }) => {
  ...
  const finalizeDragSelectionRef = (0, import_react2.useRef)(() => {
  });
  const suppressClickRef = (0, import_react2.useRef)(false);
  const [errors, setErrors] = (0, import_react2.useState)([]);
  const [layoutTick, setLayoutTick] = (0, import_react2.useState)(0);
  const [cursorMode, setCursorMode] = (0, import_react2.useState)("default");
  const [dragBox, setDragBox] = (0, import_react2.useState)(null);
  const [dragHandleDisabledAfterDrop, setDragHandleDisabledAfterDrop] = (0, import_react2.useState)(
    typeof window !== "undefined" && Boolean(window.__scoreDndBlockDragHandleUntil)
  );
  const [clefMenu, setClefMenu] = (0, import_react2.useState)(null);
  const [settingsMenu, setSettingsMenu] = (0, import_react2.useState)(null);
  ...
  const selectedNotes = (0, import_react2.useMemo)(() => {
  ...
  const updateNodeAttrs = (partial) => {
    ...
    editor.commands.command(({ tr, state, dispatch }) => {
      ...
      tr.setSelection(import_state.NodeSelection.create(tr.doc, nodePos));
  ...
  const handleClick = (event) => {
    ...
    const container = canvasRef.current;
    if (!container) return;
    const isSelected = editor.state.selection instanceof import_state.NodeSelection && editor.state.selection.from === nodePos;
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const onDocumentMouseDown = (event) => {
      ...
      if (editor && typeof getPos === "function") {
        const nodePos = getPos();
        const isNodeSelected = editor.state.selection instanceof import_state.NodeSelection && editor.state.selection.from === nodePos;
        if (isNodeSelected) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.NodeViewWrapper, { className: "score-node", "data-score-staff": node.attrs.staff, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "score-node__canvas", ref: canvasRef }),
          dragBox && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
          ...
          clefMenu && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              ...
              children: attrs.staff === "single" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u97F3\u90E8\u8A18\u53F7" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "treble", children: "\u30C8\u97F3\u8A18\u53F7" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "bass", children: "\u30D8\u97F3\u8A18\u53F7" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "alto", children: "\u30CF\u97F3\u8A18\u53F7(\u30A2\u30EB\u30C8)" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "tenor", children: "\u30CF\u97F3\u8A18\u53F7(\u30C6\u30CA\u30FC)" })
                    ]
                  }
                )
              ] })
          ...
          settingsMenu && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u62CD\u5B50" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u8ABF\u53F7" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "select",
                    {
                      ...
                      children: KEY_SIG_OPTIONS.map((option) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: option.value, children: option.label }, option.value))
                    }
                  )
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u8B5C\u8868" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "select",
                    {
                      value: attrs.staff,
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "single", children: "\u5358\u8B5C\u8868" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "grand", children: "\u5927\u8B5C\u8868" })
                      ]
                    }
                  )
                ] }),
                attrs.staff === "single" && allowMultiSingleStaff && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u6BB5\u6570" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "select",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "1", children: "1\u6BB5" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "2", children: "2\u6BB5" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "3", children: "3\u6BB5" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "4", children: "4\u6BB5" })
                      ]
                    }
                  )
                ] })
    ...
    errors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "score-node__errors", children: errors.slice(0, 3).map((error) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: error }, error)) })
  ] });
};
...
var ScoreExtension = import_core.Node.create({
  name: "score",
  group: "block",
  atom: true,
  selectable: true,
  ...
  renderHTML({ HTMLAttributes }) {
    return ["div", (0, import_core.mergeAttributes)(HTMLAttributes, { "data-type": "score" })];
  },
  addNodeView() {
    return (0, import_react3.ReactNodeViewRenderer)(ScoreNodeView_default);
  },
  addKeyboardShortcuts() {
    const handleDeleteSelectedNotes = () => {
      ...
      return editor.commands.command(({ tr, state, dispatch }) => {
        ...
        if (!currentNode) return false;
        tr.setNodeMarkup(nodePos, void 0, nextAttrs);
        tr.setSelection(import_state2.NodeSelection.create(tr.doc, nodePos));
        if (dispatch) dispatch(tr);
        return true;
      });
    };
...
var ScoreBubbleMenu = ({ editor }) => {
  const [attrs, setAttrs] = (0, import_react4.useState)(null);
  const [, setSuppressByDnd] = (0, import_react4.useState)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_menus.BubbleMenu,
    {
      ...
      children: attrs && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        (() => {
          const selected = getSelectedTokens(attrs);
          if (selected) return null;
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "score-bubble__stack", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "score-bubble__row score-bubble__row--selected-primary", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u7A2E\u985E" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "note", children: "\u97F3\u7B26" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "rest", children: "\u4F11\u7B26" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u97F3\u4FA1" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "w", children: "\u5168\u97F3\u7B26" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "h", children: "2\u5206\u97F3\u7B26" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "q", children: "4\u5206\u97F3\u7B26" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "8", children: "8\u5206\u97F3\u7B26" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "16", children: "16\u5206\u97F3\u7B26" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u4ED8\u70B9" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "0", children: "\u306A\u3057" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "1", children: "\u4ED8\u70B9" }),
                      allowDoubleDotted && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "2", children: "\u8907\u4ED8\u70B9" })
                    ]
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "score-bubble__row score-bubble__row--selected-secondary", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u9023\u7B26" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "none", children: "\u306A\u3057" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "triplet", children: "3\u9023\u7B26" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u81E8\u6642\u8A18\u53F7" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "", children: "\u306A\u3057" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "#", children: "\u30B7\u30E3\u30FC\u30D7" }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "b", children: "\u30D5\u30E9\u30C3\u30C8" })
                    ]
                  }
                )
              ] })
        ...
        (() => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "score-bubble__stack", children: [
            ...
            selected.indices.length > 1 && selected.indices.length % 3 !== 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u9023\u7B26\u6CE8\u610F" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { value: "\u8907\u6570\u9078\u629E\u30673\u9023\u7B26\u5316\u3059\u308B\u5834\u5408\u306F3\u306E\u500D\u6570\u3092\u9078\u629E", readOnly: true })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "score-bubble__hint", children: [
              "\u9078\u629E\u4E2D: ",
        ...
        !getSelectedTokens(attrs) && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "score-bubble__hint", children: "\u8B5C\u9762\u3092\u30AF\u30EA\u30C3\u30AF\u3057\u3066\u97F3\u7B26\u3092\u8FFD\u52A0" })
      ] })
    }
  );
};
